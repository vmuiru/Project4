...
urlpatterns = [
    ...
    path('articles/<int:article_id>/<int:comment_id>/delete_comment/', views.delete_comment, name='delete_comment'),
    path('articles/<int:article_id>/<int:comment_id>/update_comment/', views.update_comment, name='update_comment'),
    path('articles/<int:article_id>/<int:comment_id>/edit_comment/', views.edit_comment, name='edit_comment'),
